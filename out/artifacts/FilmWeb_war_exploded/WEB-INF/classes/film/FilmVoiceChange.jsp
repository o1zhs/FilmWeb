...
<div class="layui-container">
    ...
    <div style="text-align: center;">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
            <legend style="text-align: center;">删除旁白</legend>
        </fieldset>
        <form class="layui-form layui-form-pane" action="/FilmVoiceChange" method="post">
            <div class="layui-inline">
                <label class="layui-form-label"><font clolor="gray">选择旁白</font></label>
                <div class="layui-input-inline">
                    <select name="Filmvoice" required lay-verify="required">
            ...
            <div align="center">
                ...
                <button type="submit" class="layui-btn layui-btn-radius" style="margin-top: 30px;" onclick="this.form.id.value='2';this.form.FilmID.value='<%=ID%>';this.form.label.value='3';this.form.FilmName.value='<%=FilmName%>';javascript:return p_del()">删除旁白</button>
            </div>
        </form>
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
            <legend style="text-align: center;">添加旁白</legend>
        </fieldset>
        <form class="layui-form layui-form-pane" action="/FilmVoiceChange" method="post">
            ...
            <div align="center">
                ...
                <input type="hidden" name="label">
                <input type="hidden" name="FilmName">
                <button type="submit" class="layui-btn layui-btn-radius" style="margin-top: 30px;" onclick="this.form.id.value='1';this.form.FilmID.value='<%=ID%>';this.form.label.value='3';this.form.FilmName.value='<%=FilmName%>'">添加旁白</button>
            </div>
        </form>
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
            <legend style="text-align: center;">修改旁白</legend>
        </fieldset>
        <form class="layui-form layui-form-pane" action="/FilmVoiceUpdate" method="post" ">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label"><font clolor="gray">选择旁白</font></label>
                    <div class="layui-input-inline">
                        <select name="Filmvoice_cpre" required lay-verify="required">
                            <option value="" selected=""></option>
                            <%
                                for (Person film_voice:filmvoice){
                                    String Person_name = film_voice.getName();
            ...
            <div align="center">
                ...
                <input type="hidden" name="label">
                <input type="hidden" name="FilmName">
                <button id="3" type="submit" value="03" class="layui-btn layui-btn-radius" style="margin-top: 30px;" onclick="this.form.FilmID.value='<%=ID%>';this.form.label.value='3';this.form.FilmName.value='<%=FilmName%>'">修改旁白</button>
            </div>
        </form>
        <%
            }

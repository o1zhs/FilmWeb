...
<div class="bh">
    <div class="header">
        <div class="logo">
            <h1><a href="directorquery.html"><img src="../img/logo.png" alt=""></a></h1>
        </div>
            ...
            <td >
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="directorname" name="directorname" lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </td>
        </tr>

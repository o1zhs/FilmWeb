...
<div class="maincontainer" style="margin-left: 20px;margin-right: 20px">
    <div class="layui-row">
        <div class="layui-col-xs6">
            ...
            %>
            <table class="easyui-datagrid" title="电影信息" style="width:700px;height:480px"
        ...
        <div class="layui-col-xs6">
            <div align="center">
                <button id="5" type="submit" class="layui-btn layui-btn-primary layui-btn-radius" style="margin-top: 100px;" onclick="window.location.href='FilmOtherChangeQuery.jsp'">演员、导演、旁白、类别信息管理</button>
                </br>
                <button id="1" type="submit" class="layui-btn layui-btn-primary layui-btn-radius" style="margin-top: 200px;" onclick="window.location.href='film_insert.jsp'">添加电影</button>
                &nbsp;&nbsp;&nbsp;
                <button id="2" type="submit" class="layui-btn layui-btn-radius" style="margin-top: 200px;" onclick="window.location.href='film_delete.jsp'">删除电影</button>
                &nbsp;&nbsp;&nbsp;
                <button id="3" type="submit" class="layui-btn layui-btn-normal layui-btn-radius" style="margin-top: 200px;" onclick="window.location.href='film_update.jsp'">更新电影</button>
                &nbsp;&nbsp;&nbsp;
                <button id="4" type="submit" class="layui-btn layui-btn-normal layui-btn-radius" style="margin-top: 200px;" onclick="window.location.href='changeindex.html'">返回</button>
            </div>
        </div>
    </div>
</div>
